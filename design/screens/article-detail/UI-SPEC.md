...
| 8 | **구독 카드가 안쪽 스크롤 상자에서 안 뜬다** | `window` scroll 로 70% 를 잰다. 미리보기처럼 안쪽 상자가 스크롤되면 못 잰다. ✕ 기억이 탭 단위라 다른 글에서도 안 뜬다. `IntersectionObserver` 표지 ＋ 글 단위 기억으로 — `insight-round3.md` 2 | 다음 export |
