...
| `FilterSelect` ×3 | 조건 | **국가 · 직종 · 키워드** | **미구현**(`DS-27`). 누르면 `Popover` 가 열리고 안은 `FilterChip` 목록이다. 걸린 값을 트리거에 요약한다 |
